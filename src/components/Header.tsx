      ...
      <header className="bg-gradient-to-r from-emerald-600 to-emerald-700 shadow-lg border-b border-emerald-500/50 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="max-w-full mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20 relative z-10">
            ...
            >
              <div className="w-16 h-16 bg-gradient-to-br from-emerald-800 to-emerald-900 rounded-2xl border-3 border-white/80 shadow-xl transition-all duration-300 group-hover:drop-shadow-2xl group-hover:from-emerald-700 group-hover:to-emerald-800 group-hover:border-white group-hover:shadow-2xl group-hover:scale-105 p-2">
                <img 
                  src="https://raw.githubusercontent.com/Esporadix-team/imagenes_logos/refs/heads/main/logoAmb.png" 
                  alt="División Ambiental"
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                ...
                <span className="text-sm font-semibold text-white">Cerrar sesión</span>
              </button>
            </div>
          </div>
        </div>
