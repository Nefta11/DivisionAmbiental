...
import { X, Save, Upload, MapPin, Calendar, User, Phone, Globe, FileText, AlertTriangle, Users, Wrench, FlaskConical, FileCheck, Gavel, Recycle, Megaphone, CheckCircle, XCircle } from 'lucide-react';
...
const EditReportModal: React.FC<EditReportModalProps> = ({ report, onSave, onCancel }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Enviando datos del formulario:', formData); // Para debug
    console.log('Datos originales del reporte:', report); // Para debug
    onSave(formData);
  };
